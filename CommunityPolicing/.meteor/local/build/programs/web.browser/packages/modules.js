...
install("meteor");                                                                                            // 33
install("insecure");                                                                                          // 34
install("bevanhunt:leaflet");                                                                                 // 35
install("bdunnette:leaflet-draw");                                                                            // 36
install("modules-runtime");                                                                                   // 37
install("modules", "meteor/modules/client.js");                                                               // 38
install("jquery", "meteor/jquery/main.js");                                                                   // 39
install("twbs:bootstrap");                                                                                    // 40
install("tracker");                                                                                           // 41
install("base64");                                                                                            // 42
install("ejson");                                                                                             // 43
...
install("htmljs");                                                                                            // 57
install("blaze");                                                                                             // 58
install("spacebars");                                                                                         // 59
install("templating-compiler");                                                                               // 60
install("templating-runtime");                                                                                // 61
install("templating");                                                                                        // 62
install("artwells:queue");                                                                                    // 63
install("coffeescript");                                                                                      // 64
install("zhenya:forkme");                                                                                     // 65
install("meteor-base");                                                                                       // 66
install("mobile-experience");                                                                                 // 67
install("ordered-dict");                                                                                      // 68
install("geojson-utils", "meteor/geojson-utils/main.js");                                                     // 69
install("minimongo");                                                                                         // 70
install("retry");                                                                                             // 71
install("ddp-common");                                                                                        // 72
install("reload");                                                                                            // 73
install("ddp-client");                                                                                        // 74
install("ddp");                                                                                               // 75
install("ddp-server");                                                                                        // 76
install("allow-deny");                                                                                        // 77
install("mongo");                                                                                             // 78
install("blaze-html-templates");                                                                              // 79
install("reactive-dict");                                                                                     // 80
install("session");                                                                                           // 81
install("logging");                                                                                           // 82
install("brylie:leaflet-heat");                                                                               // 83
install("ui");                                                                                                // 84
install("juliancwirko:s-alert");                                                                              // 85
install("ddp-rate-limiter");                                                                                  // 86
install("localstorage");                                                                                      // 87
install("callback-hook");                                                                                     // 88
install("accounts-base", "meteor/accounts-base/client_main.js");                                              // 89
install("sha");                                                                                               // 90
install("srp");                                                                                               // 91
install("accounts-password");                                                                                 // 92
install("simple:json-routes");                                                                                // 93
install("nimble:restivus");                                                                                   // 94
install("email");                                                                                             // 95
install("amplify");                                                                                           // 96
install("u2622:persistent-session");                                                                          // 97
install("postrednik:meteor-rangeslider");                                                                     // 98
install("momentjs:moment");                                                                                   // 99
install("herrhelms:meteor-leaflet-markercluster");                                                            // 100
install("shell-server");                                                                                      // 101
install("juliancwirko:postcss");                                                                              // 102
install("anti:i18n");                                                                                         // 103
install("aslagle:reactive-table");                                                                            // 104
install("anbuselvan:meteor-toggle-switch", "meteor/anbuselvan:meteor-toggle-switch/meteor-toggle-switch.js");
install("iron:core");                                                                                         // 106
install("iron:dynamic-template");                                                                             // 107
install("iron:layout");                                                                                       // 108
install("iron:url");                                                                                          // 109
install("iron:middleware-stack");                                                                             // 110
install("iron:location");                                                                                     // 111
install("iron:controller");                                                                                   // 112
install("iron:router");                                                                                       // 113
install("d3js:d3");                                                                                           // 114
install("stylus");                                                                                            // 115
install("tsega:bootstrap3-datetimepicker");                                                                   // 116
install("service-configuration");                                                                             // 117
install("less");                                                                                              // 118
install("accounts-ui-unstyled");                                                                              // 119
install("accounts-ui");                                                                                       // 120
install("webapp");                                                                                            // 121
